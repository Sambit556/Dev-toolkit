...
export const metadata: Metadata = {
  ...
  description:
    'Support DevChrono JSONLab development via PayPal or UPI. Your contribution helps keep this free, privacy-first developer toolkit running.',
  ...
  return (
    <div className="container py-10 md:py-14 max-w-2xl">
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl md:text-3xl font-bold mb-2">Support DevChrono JSONLab</h1>
