export interface Unit { value: string; label: string; multiplier: number; }
export interface UnitCategory { id: string; name: string; baseUnit: string; units: Unit[]; }

export const UNIT_CATEGORIES: UnitCategory[] = [
  { id: 'length', name: 'Length', baseUnit: 'm', units: [
  ...
  { id: 'mass', name: 'Mass & Weight', baseUnit: 'kg', units: [
  ...
  { id: 'area', name: 'Area', baseUnit: 'm2', units: [
  ...
  { id: 'volume', name: 'Volume', baseUnit: 'L', units: [
  ...
  { id: 'time', name: 'Time Duration', baseUnit: 's', units: [
  ...
  { id: 'storage', name: 'Digital Storage', baseUnit: 'B', units: [
    { value: 'bit', label: 'Bits (b)', multiplier: 0.125 },
    { value: 'B', label: 'Bytes (B)', multiplier: 1 },
    { value: 'KB', label: 'Kilobytes (KB)', multiplier: 1000 },
    { value: 'MB', label: 'Megabytes (MB)', multiplier: 1000000 },
    { value: 'GB', label: 'Gigabytes (GB)', multiplier: 1000000000 },
    { value: 'TB', label: 'Terabytes (TB)', multiplier: 1000000000000 },
    { value: 'PB', label: 'Petabytes (PB)', multiplier: 1000000000000000 },
    { value: 'KiB', label: 'Kibibytes (KiB)', multiplier: 1024 },
    { value: 'MiB', label: 'Mebibytes (MiB)', multiplier: 1048576 },
    { value: 'GiB', label: 'Gibibytes (GiB)', multiplier: 1073741824 },
    { value: 'TiB', label: 'Tebibytes (TiB)', multiplier: 1099511627776 },
  ] },
  { id: 'energy', name: 'Energy', baseUnit: 'J', units: [
  ...
  { id: 'pressure', name: 'Pressure', baseUnit: 'Pa', units: [
...
export function convertUnit(value: number, fromUnit: string, toUnit: string, categoryId: string): number {
  ...
  if (!from || !to) throw new Error(`Unknown unit(s) "${fromUnit}"/"${toUnit}" for category "${categoryId}"`);
